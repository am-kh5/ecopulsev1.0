...
const SIDEBAR_WIDTH_ICON = "3rem" // Corresponds to size-12 in Tailwind (w-12 or h-12)
...
>(
  (
    ...
    const contextValue = React.useMemo<SidebarContextValue>(
      ...
      [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, collapsibleProp]
    )
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-4 group-data-[collapsible=icon]/sidebar:items-center group-data-[collapsible=icon]/sidebar:p-2.5 transition-all duration-300 ease-in-out", className)}
      {...props}
    />
  )
})
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] ease-in-out duration-300 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]/sidebar:!size-9 group-data-[collapsible=icon]/sidebar:!p-2 [&>svg]:size-4 [&>svg]:shrink-0 [&>span:last-child]:truncate [&>span:last-child]:transition-all [&>span:last-child]:ease-in-out [&>span:last-child]:duration-300 group-data-[collapsible=icon]/sidebar:[&>span:last-child]:opacity-0 group-data-[collapsible=icon]/sidebar:[&>span:last-child]:w-0 group-data-[collapsible=icon]/sidebar:[&>span:last-child]:invisible",
  {
    variants: {
      variant: {
...
>(
  (
    ...
    const showTooltip = !isMobile && state === "collapsed" && collapsible === "icon";
